<html>
 ...
 <body>
  ...
  <p>If, for some unknown reason, wanna run this at home I suggest you check how many cores your CPU has and then change in the includes/pi.h file the #define NUM_THREADS from 6 to your name of cores</p>
